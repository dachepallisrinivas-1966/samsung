...
public class PersonController {
	...
	@ResponseBody
	public String action(@RequestParam(name = "name") String personName) {
		return "URL parameter - " + "name =" + personName;
	}
	...
	@ResponseBody
	public String action(@RequestParam String firstName, @RequestParam String lastName) {

		return "URL parameters - " + " firstName = " + firstName + " - " + " lastName = " + lastName;
	}
	...
	@ResponseBody
	public String action(@RequestParam("name") String name, @RequestParam("age") int age,
	...
	@ResponseBody
	public String action(@RequestParam Map<String, String> params) {
	 ...
	 * method parameter as Optional i.e. it bind a null value to method parameter if
	 ...
	 * Java 8 classes - LocalDate, LocalTime, DateTimeFormat
	 */
	@RequestMapping("/request6")
	@ResponseBody
	public String action(@DateTimeFormat(pattern = "yyyy-MM-dd") @RequestParam("date") LocalDate date,
	...
	@ResponseBody
	public String action(@RequestParam("country") String[] country, @RequestParam("city") List<String> city) {
	...
	@ResponseBody
	public String action(@RequestParam(name = "code", defaultValue = "10") int code) {
